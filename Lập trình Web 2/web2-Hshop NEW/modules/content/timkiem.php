<?php 
		$conn = mysqli_connect("localhost","root","","Hshop") or die("Kết nối thất bại");
...
<div id="maincontent" class="col-xs-12 col-sm-8 col-md-12" >
				<div  class="text-left">
                    <form action="index.php" method="get">
                        ...
                        <button type="button" class="btn btn-info" onclick="timkiem()" name="xem" value="search" style="background:  #15292f; id="timkiemnc">Tìm kiếm</button>
                    </form>
                </div>
				<div class="boxmain">
