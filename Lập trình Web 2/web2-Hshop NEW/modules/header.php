...
<header id="header">
		<div class="topbar">
			<div class="container-fluid">
				<div class="col-xs-12 col-sm-6 p0 col-md-3 hotline-top">
					...
					<p>Hotline: <a href="tel:01234.567.789">0123456789</a></p>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div id="search">
						<form action="" method="get">
							...
							<button type="submit" name="xem" value="search" style="background-color: #223b42;">Tìm kiếm</button>
						</form>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
		...
		<nav id="mainmenu" style="background-color:  #15292f;">
			<div class="container">
				<ul class="x1">
						<li id="menudrop">
					...
					<li><a href="tel:01649.629.629">HOTLINE: 0123456789 (Cả ngày)</a></li>
				</ul>
			</div>
		</nav>
	</header>
